...
<section class="hbox stretch">
    <?php
    //Quick Navigation
    $this->load->view('inc/quick_navigation');
    ...
    <section class="vbox">        
        ...
        //Main Navigation
        $this->load->view('inc/main_navigation');
    ...
    <a href="prospect.html#" class="hide nav-off-screen-block" data-toggle="class:nav-off-screen" data-target="#nav"></a>
    </section>
    <!-- /.vbox -->    
